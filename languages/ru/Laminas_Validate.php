...
return array(
    ...
    "Invalid type given, value should be string, integer, array or Laminas_Date" => "Недопустимый тип данных, значение должно быть строкой, целым числом, массивом или объектом Laminas_Date",
