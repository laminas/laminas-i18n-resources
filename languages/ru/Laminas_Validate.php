...
return [
    ...
    "File '%value%' exceeds upload_max_filesize directive in php.ini" => "Размер файла '%value%' превышает допустимый размер, указанный в php.ini",
    "File '%value%' exceeds the MAX_FILE_SIZE directive that was specified in the HTML form" => "Размер файла '%value%' превышает допустимый размер, указанный в форме",
    ...
    "Missing a temporary folder to store '%value%'" => "Не найдена временная директория для файла '%value%'",
    "Failed to write file '%value%' to disk" => "Файл '%value%' не может быть записан",
    "A PHP extension stopped uploading the file '%value%'" => "PHP расширение возвратило ошибку во время загрузки файла '%value%'",
    ...
    "The uploaded file exceeds the upload_max_filesize directive in php.ini" => "Размер файла превышает допустимый размер, указанный в php.ini",
    "The uploaded file exceeds the MAX_FILE_SIZE directive that was specified in the HTML form" => "Размер файла превышает допустимый размер, указанный в форме",
    "The uploaded file was only partially uploaded" => "Файл был загружен только частично",
    "No file was uploaded" => "Файл не был загружен",
    "Missing a temporary folder" => "Не найдена временная директория для файла",
    "Failed to write file to disk" => "Файл не может быть записан",
    "A PHP extension stopped the file upload" => "PHP расширение возвратило ошибку во время загрузки файла",
