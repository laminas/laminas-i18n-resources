...
return [
    ...
    "The uploaded file exceeds the upload_max_filesize directive in php.ini" => "Datoteka presega definirano ini vrednost",
    "The uploaded file exceeds the MAX_FILE_SIZE directive that was specified in the HTML form" => "Datoteka presega velikost definirano v obrazcu",
    "The uploaded file was only partially uploaded" => "Datoteka je bila samo delno naložena",
    "No file was uploaded" => "Datoteka ni bila naložena",
    "Missing a temporary folder" => "Začasnega direktorija ni bilo mogoče najti za datoteko",
    "Failed to write file to disk" => "Datoteke ni bilo mogoče zapisati",
    "A PHP extension stopped the file upload" => "PHP razširitev je vrnila napako med nalaganjem datoteke",
