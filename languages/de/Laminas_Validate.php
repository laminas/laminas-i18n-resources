...
return [
    ...
    "The uploaded file exceeds the upload_max_filesize directive in php.ini" => "Die Datei übersteigt die definierte Größe in der Konfiguration",
    "The uploaded file exceeds the MAX_FILE_SIZE directive that was specified in the HTML form" => "Die Datei übersteigt die definierte Größe des Formulars",
    "The uploaded file was only partially uploaded" => "Die Datei wurde nur teilweise hochgeladen",
    "No file was uploaded" => "Die Datei wurde nicht hochgeladen",
    "Missing a temporary folder" => "Für die Datei wurde kein temporäres Verzeichnis gefunden",
    "Failed to write file to disk" => "Die Datei konnte nicht geschrieben werden",
    "A PHP extension stopped the file upload" => "Eine PHP Erweiterung hat einen Fehler ausgegeben während die Datei hochgeladen wurde",
