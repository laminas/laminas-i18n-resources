...
return array(
    ...
    "Invalid type given. String, integer or float expected" => "Ugyldig type gitt. Streng, heltall eller flyttall forventet",
    ...
    "Invalid type given. String expected" => "Ugyldig type er gitt. Streng er forventet",
    ...
    "Invalid type given. String expected" => "Ugyldig type gitt. Streng forventet",
    "'%value%' contains an invalid amount of digits" => "'%value%' inneholder et ugyldig antall sifre",
    ...
    "Invalid type given. String, integer, array or Laminas_Date expected" => "Ugyldig type gitt. Streng, heltall, array eller Laminas_Date forventet",
    ...
    "All files in sum should have a maximum size of '%max%' but '%size%' were detected" => "Alle filer i sum skal ha en maksimal størrelse på '%max%', men '%size%' ble påvist",
    "All files in sum should have a minimum size of '%min%' but '%size%' were detected" => "Alle filer i sum skal ha en minimum størrelse på '%min%' but '%size%' ble påvist",
    ...
    "Invalid type given. String expected" => "Ugyldig type gitt. Streng froventet",
    ...
    "Invalid type given. String or integer expected" => "Ugyldig type gitt. Streng eller heltall forventet",
    ...
    "Invalid type given. String, integer, float, boolean or array expected" => "Ugyldig type gitt. Streng, heltall, flyttall, boolean eller array forventet",
    ...
    "Invalid type given. String, integer or float expected" => "Ugyldig type gitt. String, heltall eller flyttall forventet",
    ...
    "Invalid type given. Numeric string, integer or float expected" => "Ugyldig type gitt. Numerisk streng, heltall eller flyttall forventet",
