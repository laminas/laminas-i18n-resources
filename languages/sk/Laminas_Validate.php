...
return [
    ...
    "File '%value%' exceeds upload_max_filesize directive in php.ini" => "Súbor '%value%' prekročil veľkosť definovanú v ini súbore",
    "File '%value%' exceeds the MAX_FILE_SIZE directive that was specified in the HTML form" => "Súbor '%value%' prekročil veľkosť definovanú vo formulári",
    ...
    "Missing a temporary folder to store '%value%'" => "Pre súbor '%value%' nebol nájdený žiadny dočasný adresár",
    "Failed to write file '%value%' to disk" => "Súbor '%value%' nemôže byť zapísaný",
    "A PHP extension stopped uploading the file '%value%'" => "PHP rozšírenie vrátilo chybu počas nahrávania súboru '%value%'",
    ...
    "The uploaded file exceeds the upload_max_filesize directive in php.ini" => "Súbor prekročil veľkosť definovanú v ini súbore",
    "The uploaded file exceeds the MAX_FILE_SIZE directive that was specified in the HTML form" => "Súbor prekročil veľkosť definovanú vo formulári",
    "The uploaded file was only partially uploaded" => "Súbor bol odoslaný len čiastočne",
    "No file was uploaded" => "Súbor nebol odoslaný",
    "Missing a temporary folder" => "Pre súbor nebol najdený žiadny dočasný adresár",
    "Failed to write file to disk" => "Súbor nemože byť zapisaný",
    "A PHP extension stopped the file upload" => "PHP rozšírenie vrátilo chybu počas nahrávania súboru",
