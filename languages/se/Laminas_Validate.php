...
return [
    ...
    // Laminas_I18n_Validator_PostCode
    ...
    // Laminas_Validator_Explode
    "Invalid type given. String expected" => "Ogiltig typ given. Sträng förväntad",

    // Laminas_Validator_File_Count
    ...
    // Laminas_Validator_File_ExcludeExtension
    "File '%value%' has a false extension" => "Filen '%value%' har en felaktig filändelse",
    "File '%value%' is not readable or does not exist" => "Filen '%value%' är inte läsbar eller existerar inte",

    // Laminas_Validator_File_Exists
    "File '%value%' does not exist" => "Filen '%value%' existerar inte",

    // Laminas_Validator_File_Extension
    "File '%value%' has a false extension" => "Filen '%value%' har en felaktig filändelse",
    "File '%value%' is not readable or does not exist" => "Filen '%value%' är inte läsbar eller existerar inte",

    // Laminas_Validator_File_FilesSize
    ...
    // Laminas_Validator_File_ImageSize
    ...
    // Laminas_Validator_File_IsCompressed
    ...
    // Laminas_Validator_File_UploadFile
    "The uploaded file exceeds the upload_max_filesize directive in php.ini" => "Filen överskrider den definerade ini-storleken",
    "The uploaded file exceeds the MAX_FILE_SIZE directive that was specified in the HTML form" => "Filen överskrider den definerade formulär-storleken",
    "The uploaded file was only partially uploaded" => "Filen blev enbart delvis uppladdad",
    "No file was uploaded" => "Filen laddades inte upp",
    "Missing a temporary folder" => "Ingen temporär mapp hittades för filen",
    "Failed to write file to disk" => "Filen kan inte skrivas",
    "A PHP extension stopped the file upload" => "Ett PHP-tillägg returnerade ett fel när filen laddades upp",
    ...
    // Laminas_Validator_File_WordCount
