...
return array(
    ...
    "Invalid type given, value should be string, integer, array or Laminas_Date" => "El tipo especificado no es válido, el valor debe ser una cadena de texto, entero, array o un objeto Laminas_Date",
