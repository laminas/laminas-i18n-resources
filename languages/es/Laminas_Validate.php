...
return [
    ...
    "File '%value%' exceeds upload_max_filesize directive in php.ini" => "El tamaño del archivo '%value%' excede el valor definido en el ini",
    "File '%value%' exceeds the MAX_FILE_SIZE directive that was specified in the HTML form" => "El archivo '%value%' excede el tamaño definido en el formulario",
    ...
    "Missing a temporary folder to store '%value%'" => "No se ha encontrado el directorio temporal para el archivo '%value%'",
    "Failed to write file '%value%' to disk" => "No se puede escribir en el archivo '%value%'",
    "A PHP extension stopped uploading the file '%value%'" => "Una extensión PHP devolvió un error mientras se subía el archivo '%value%'",
    ...
    "The uploaded file exceeds the upload_max_filesize directive in php.ini" => "El tamaño del archivo excede el valor definido en el ini",
    "The uploaded file exceeds the MAX_FILE_SIZE directive that was specified in the HTML form" => "El archivo excede el tamaño definido en el formulario",
    "The uploaded file was only partially uploaded" => "El archivo fue sólo parcialmente subido",
    "No file was uploaded" => "El archivo no ha sido subido",
    "Missing a temporary folder" => "No se ha encontrado el directorio temporal para el archivo",
    "Failed to write file to disk" => "No se puede escribir en el archivo",
    "A PHP extension stopped the file upload" => "Una extensión PHP devolvió un error mientras se subía el archivo",
