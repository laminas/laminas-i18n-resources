...
return [
    ...
    "The uploaded file exceeds the upload_max_filesize directive in php.ini" => "Het bestand overschrijdt de ini grootte",
    "The uploaded file exceeds the MAX_FILE_SIZE directive that was specified in the HTML form" => "Het bestand overschrijdt de formulier grootte",
    "The uploaded file was only partially uploaded" => "Het bestand was slechts gedeeltelijk geüpload",
    "No file was uploaded" => "Het bestand was niet geüpload",
    "Missing a temporary folder" => "Geen tijdelijke map was gevonden voor bestand",
    "Failed to write file to disk" => "Het bestand kan niet worden geschreven",
    "A PHP extension stopped the file upload" => "Een PHP-extensie gaf een foutmelding terug tijdens het uploaden van het bestand",
