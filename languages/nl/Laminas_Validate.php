...
return array(
    ...
    "Invalid type given, value should be string, integer, array or Laminas_Date" => "Ongeldig type opgegeven, waarde moet een string, integer, array of Laminas_Date zijn",
