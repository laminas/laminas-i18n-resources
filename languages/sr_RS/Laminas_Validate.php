...
return [
    ...
    "The uploaded file exceeds the upload_max_filesize directive in php.ini" => "Фајл превазилази дефинисану ini величину",
    "The uploaded file exceeds the MAX_FILE_SIZE directive that was specified in the HTML form" => "Фајл превазилази дефинисану form величину",
    "The uploaded file was only partially uploaded" => "Фајл је само делимично учитан",
    "No file was uploaded" => "Фајл није учитан",
    "Missing a temporary folder" => "Није пронађен привремени директоријум за фајл",
    "Failed to write file to disk" => "Фајл не може бити написан",
    "A PHP extension stopped the file upload" => "PHP екстензија је дала грешку приликом учитавања фајла",
