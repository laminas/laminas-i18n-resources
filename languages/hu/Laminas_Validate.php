...
return [
    ...
    "The uploaded file exceeds the upload_max_filesize directive in php.ini" => "A fájl mérete meghaladja a PHP beállításokban megengedettet",
    ...
    "No file was uploaded" => "A fájl nem lett feltöltve",
    "Missing a temporary folder" => "A fájl számára nem található átmeneti könyvtár",
    "Failed to write file to disk" => "A fájl nem írható",
    "A PHP extension stopped the file upload" => "Egy PHP kiterjesztés nem várt hibát okozott a fájl feltöltése közben",
