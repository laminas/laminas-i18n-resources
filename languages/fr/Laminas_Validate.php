...
return [
    ...
    "File '%value%' exceeds upload_max_filesize directive in php.ini" => "Le fichier '%value%' dépasse la taille définie dans le fichier INI",
    "File '%value%' exceeds the MAX_FILE_SIZE directive that was specified in the HTML form" => "Le fichier '%value%' dépasse la taille définie dans le formulaire",
    ...
    "Missing a temporary folder to store '%value%'" => "Le dossier temporaire n'a pas été trouvé pour le fichier '%value%'",
    "Failed to write file '%value%' to disk" => "Impossible d'écrire dans le fichier '%value%'",
    "A PHP extension stopped uploading the file '%value%'" => "Une extension PHP a retourné une erreur en envoyant le fichier '%value%'",
    ...
    "The uploaded file exceeds the upload_max_filesize directive in php.ini" => "Le fichier dépasse la taille définie dans le fichier INI",
    "The uploaded file exceeds the MAX_FILE_SIZE directive that was specified in the HTML form" => "Le fichier dépasse la taille définie dans le formulaire",
    "The uploaded file was only partially uploaded" => "Le fichier n'a été que partiellement envoyé",
    "No file was uploaded" => "Le fichier n'a pas été envoyé",
    "Missing a temporary folder" => "Le dossier temporaire n'a pas été trouvé pour le fichier",
    "Failed to write file to disk" => "Impossible d'écrire dans le fichier",
    "A PHP extension stopped the file upload" => "Une extension PHP a retourné une erreur en envoyant le fichier",
