...
return [
    ...
    "The uploaded file exceeds the upload_max_filesize directive in php.ini" => "ファイルは ini で定義されたサイズを超えています",
    "The uploaded file exceeds the MAX_FILE_SIZE directive that was specified in the HTML form" => "ファイルはフォームで定義されたサイズを超えています",
    "The uploaded file was only partially uploaded" => "ファイルは一部のみしかアップロードされていません",
    "No file was uploaded" => "ファイルはアップロードされませんでした",
    "Missing a temporary folder" => "ファイルをアップロードする一時ディレクトリが見つかりませんでした",
    "Failed to write file to disk" => "ファイルは書き込めませんでした",
    "A PHP extension stopped the file upload" => "ファイルをアップロード中に拡張モジュールがエラーを応答しました",
