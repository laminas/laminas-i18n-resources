...
return [
    ...
    "Invalid type given. String, integer, array or DateTime expected" => "Неправильний тип даних. Значення має бути рядком, цілим числом, масивом або об'єктом Laminas_Date",
    ...
    "The uploaded file exceeds the upload_max_filesize directive in php.ini" => "Розмір файлу перевищує дозволений, вказаний в php.ini",
    "The uploaded file exceeds the MAX_FILE_SIZE directive that was specified in the HTML form" => "Розмір файлу перевищує дозволений, вказаний у формі",
    "The uploaded file was only partially uploaded" => "Файл було завантажено тільки частково",
    "No file was uploaded" => "Файл '%value%' не було завантажено",
    "Missing a temporary folder" => "Не знайдено тимчасову теку для файлу",
    "Failed to write file to disk" => "Файл '%value%' не може бути записаний",
    "A PHP extension stopped the file upload" => "PHP-розширення повернуло помилку під час завантаження файлу",
