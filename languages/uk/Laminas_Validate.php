...
return array(
    ...
    "Invalid type given, value should be string, integer, array or Laminas_Date" => "Неприпустимий тип даних, значення повинно бути рядком, цілим числом, масивом чи об'єктом Laminas_Date",
