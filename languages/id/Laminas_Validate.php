...
return [
    ...
    "The uploaded file exceeds the upload_max_filesize directive in php.ini" => "Berkas melebihi ukuran ini yang didefinisikan",
    "The uploaded file exceeds the MAX_FILE_SIZE directive that was specified in the HTML form" => "Berkas melebihi ukuran form yang didefinisikan",
    "The uploaded file was only partially uploaded" => "Berkas hanya sebagian terupload",
    "No file was uploaded" => "Berkas tidak dapat terupload",
    "Missing a temporary folder" => "Tidak ada direktori sementara yang ditemukan untuk berkas",
    "Failed to write file to disk" => "Berkas tidak dapat ditulis",
    "A PHP extension stopped the file upload" => "Ekstensi PHP mengembalikan galat pada saat upload berkas",
