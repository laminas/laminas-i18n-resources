...
return array(
    ...
    "Invalid type given, value should be string, integer, array or Laminas_Date" => "O tipo especificado é inválido, o valor deve ser string, inteiro, matriz ou Laminas_Date",
