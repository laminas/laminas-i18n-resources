...
return array(
    ...
    "Invalid type given. String, integer, array or Laminas_Date expected" => "O tipo especificado é inválido, o valor deve ser string, inteiro, matriz ou Laminas_Date",
