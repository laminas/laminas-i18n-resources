...
return array(
    ...
    "Invalid type given. String, integer, array or Laminas_Date expected" => "Tipo di dato non valido. Era atteso un dato di tipo string, integer, array o Laminas_Date",
