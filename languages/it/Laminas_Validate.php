...
return [
    ...
    "The uploaded file exceeds the upload_max_filesize directive in php.ini" => "Il file eccede la dimensione definita nell'ini",
    "The uploaded file exceeds the MAX_FILE_SIZE directive that was specified in the HTML form" => "Il file eccede la dimensione definita nella form",
    "The uploaded file was only partially uploaded" => "Il file è stato caricato solo parzialmente",
    "No file was uploaded" => "Il file non è stato caricato",
    "Missing a temporary folder" => "Non è stata trovata una directory temporanea per il file",
    "Failed to write file to disk" => "Il file non può essere scritto",
    "A PHP extension stopped the file upload" => "Un'estensione di PHP ha generato un errore durante il caricamento del file",
