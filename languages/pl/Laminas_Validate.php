...
return [
    ...
    "The uploaded file exceeds the upload_max_filesize directive in php.ini" => "Rozmiar pliku przekroczył zdefiniowaną wartość w ini",
    "The uploaded file exceeds the MAX_FILE_SIZE directive that was specified in the HTML form" => "Rozmiar pliku przekroczył zdefiniowaną wartość w formularzu",
    "The uploaded file was only partially uploaded" => "Plik nie został całkowicie wysłany",
    "No file was uploaded" => "Plik nie został wysłany",
    "Missing a temporary folder" => "Nie zdefiniowano tymczasowego katalogu",
    "Failed to write file to disk" => "Nie można zapisać pliku",
    "A PHP extension stopped the file upload" => "Rozszerzenie PHP zgłosiło wyjątek podczas wysyłania pliku",
